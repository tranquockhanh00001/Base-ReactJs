...
import UpadteQAQuizzes from './UpdateQAQuizzes';
                            ...
                            <fieldset className="border rounded-3 p-3">
                                ...
                                <div className="more-actions form-group">
                                    <label className='form-label label-upload' htmlFor='labelUpload'>
                                        <FcPlus className='btn-choose'/> Choose Quiz's Image
                                    </label>
                                    <input 
                                        type = "file" 
                                ...
                                <div className='mt-3'>
                                    <button
                                        ...
                                        className='button-29'>Save</button>
                                </div>
                            </fieldset>
                        </div>
                        <div className="list-detail mb-5">
                            <TableQuiz />
                        </div>
                    </Accordion.Body>
                </Accordion.Item>
